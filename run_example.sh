...
time ../bin/Tang_stats ./Window_1.txt 10000 61 0.1 123456 6 5 10 15 12 15 4 BRG BRM CHCU CHCA CHFR TXL
...
time ../bin/Tang_stats ./Window_100_rows.txt 100 61 0.1 123456 6 5 10 15 12 15 4 BRG BRM CHCU CHCA CHFR TXL
